...
{
    [RAFtestCase("Initial Banner", "TC002", TestType.UI, "Maja Čanaki")]
    public class TC002_InitialBannerFail : UITestCase
    {
        [Test]
        public void InitialBannerFail()
        {
            ...
            Success = VontobelMarkets.Home.InitialBanner.btnCookieSettings.Enabled(false);
